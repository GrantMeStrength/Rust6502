...
use mos6502::cpu;
 ...
 pub fn main()  {
	...
	let mut cpu6502 : cpu650c02::CPU6502JK = cpu650c02::CPU6502JK::new();
	
	println!("Resetting 6502...");
	cpu6502.reset();

	println!("Loading some data into memory - it's my test code!");
	cpu6502.load_data_into_memory(0x0000, vec![0xA2, 0x01, 0xA0, 0x02, 0xA9, 0x03, 0x4C, 0x0A, 0x00, 0x00, 0xA2, 0x04, 0xE8, 0xA0, 0x09, 0xC8, 0xA9, 0x06, 0x18, 0x90, 0x01, 0x00, 0xEA, 0xF8, 0x38, 0xD8, 0x18, 0x58, 0xB8, 0xAA, 0x8A, 0xA8, 0x98, 0x20, 0x5F, 0x00, 0xA9, 0x01, 0xE0, 0x02, 0xC0, 0x03, 0x0A, 0x6A, 0x2A, 0x69, 0x80, 0x69, 0x01, 0xE9, 0x01, 0xE9, 0x80, 0xA5, 0x64, 0xA9, 0x2A, 0x85, 0x64, 0xA5, 0x64, 0x4A, 0xA2, 0x04, 0xA5, 0x05, 0xB5, 0x05, 0xB5, 0x64, 0xB9, 0x64, 0x00, 0xA9, 0x2A, 0x95, 0x64, 0xB5, 0x64, 0x99, 0x64, 0x00, 0xB9, 0x64, 0x00, 0x09, 0x07, 0x15, 0x12, 0x15, 0x64 , 0x4C, 0x5B, 0x00 , 0x00 , 0xA9, 0x00, 0xF8 , 0x38 , 0x60 , 0x40 , 0x20 , 0x10 , 0x07, 0x09, 0x0B , 0x0D , 0x11 , 0x13 , 0x17]);
